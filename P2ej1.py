readme= """# <a href="https://numpy.org/"><img alt="NumPy" src="/branding/logo/primary/numpylogo.svg" height="60"></a>
...
lista_readme= (readme.split("\n"))
lista_lineas= []
for actual in lista_readme:
		if ("https" or "http") in actual:
				lista_lineas.append (actual)
print (lista_lineas)
